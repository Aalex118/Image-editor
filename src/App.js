      ...
      <div className="App">
          <div className='toolbar-nav'>
              ...
              <ul ref='menu' id="toolbar-menu">
                  ...
                  }} className="toolbar-menu--button">Open</li><br></br><br></br>
                  <li onClick={() => {
          ...
          <div className='workspace-box'>
              <canvas ref='canvas' width={window.innerWidth-100} height={window.innerHeight - 125} id="mycanvas">Canvas doesn`t work</canvas>
          ...
          <div className='fucntion-nav-box'>
              ...
              <div className='functions-nav'>
                  <ul className='functions-menu'><br></br><br></br><br></br><br></br>
                      ...
                      }}>Mirroring</a></li><br></br><br></br><br></br>
                      <li><a className='functions-menu--button' onClick={()=>{
                      ...
                      }}>Effects</a></li><br></br><br></br><br></br>
                  </ul>
              </div>
          </div>
      </div>
